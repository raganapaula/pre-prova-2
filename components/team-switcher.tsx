      ...
      <SidebarMenuItem>
        <DropdownMenu>
          ...
          <DropdownMenuContent
            ...
            sideOffset={4}
          >
            <DropdownMenuLabel className="text-xs text-muted-foreground">Sistemas</DropdownMenuLabel>
            ...
            <DropdownMenuItem className="gap-2 p-2">
              ...
              <div className="font-medium text-muted-foreground">Adicionar sistema</div>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </SidebarMenuItem>
